...
human-readable instruction forms → structural normalization → typed semantic objects → architectural emission → Windows x64 PE reality. 
...
--- 
## P.I.E. Is Not Branding — It Is Law 
...
* Real imports 
* Real bytes 
If it can’t be emitted as machine code, it doesn’t exist. 
--- 
...
There is no “VM illusion.” 
There is no “future feature placeholder.” 
...
* Virtual registers → stack slots → physical registers 
...
No capability imported → no cost paid. 
...
8. Execution behaves exactly as described—or fails loudly. 
That’s the deal. 
